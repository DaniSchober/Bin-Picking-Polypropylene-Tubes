...
Connect UR5 and Camera, start UR5, set remote control, and then run:
cd ~/Documents/GitHub/Bin-Picking-Tubes/robodk_hand_eye_calibration
python3 robodk_hand_eye_calibration.py --eth --ip 192.168.2.1 --target-keyword pose_
"""
